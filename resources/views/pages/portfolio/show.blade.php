...
<section class="bg-navy-900 bg-brass-glow py-16 lg:py-20 reveal">
  <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
    <p class="text-xs font-sans font-semibold uppercase tracking-widest text-brass-300 mb-4">Kerja Sama Selanjutnya</p>
    ...
    <p class="text-navy-100 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
      Tim kami siap mendampingi dari tahap perencanaan hingga selesai —
      IT, interior, maupun konstruksi.
    </p>
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
      <x-button as="a" href="{{ route('contact') }}" variant="accent" size="lg">Konsultasi Gratis</x-button>
      <x-button as="a" href="{{ route('portfolio.index') }}" variant="light" size="lg">Lihat Proyek Lainnya</x-button>
    </div>
  </div>
</section>
